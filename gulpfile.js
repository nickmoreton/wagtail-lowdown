...
var scriptsJsPath = 'app/static/js'; //folder for final scripts.js/scripts.min.js files
...
gulp.task('watch', gulp.series(['browserSync', 'sass', 'scripts'], function () {
  ...
  gulp.watch('app/**/*.py', gulp.series(reload));
...
gulp.task('dist', async function () {
  ...
  await moveJS();
  // copy all the assets inside src/img folder to the dist folder
  await moveAssets();
